        ...
        <div className="bg-white ">
          ...
          <div className="w-hull text-center block mt-2 text-xs text-gray-600">
            ...
            <Link
              ...
              target={'_blank'}
              href={locale === 'en' ? 'https://docs.xiaosuan.com/apps/user-agreement/terms-of-service' : 'https://docs.xiaosuan.com/apps/v/zh-hans/yong-hu-xie-yi/fu-wu-xie-yi'}
            >{t('login.tos')}</Link>
            &nbsp;&&nbsp;
            <Link
              className='text-primary-600'
              target={'_blank'}
              href={locale === 'en' ? 'https://docs.xiaosuan.com/apps/user-agreement/privacy-policy' : 'https://docs.xiaosuan.com/apps/v/zh-hans/yong-hu-xie-yi/yin-si-xie-yi'}
            >{t('login.pp')}</Link>
          </div>
