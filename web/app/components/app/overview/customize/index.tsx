...
const CustomizeModal: FC<IShareLinkProps> = ({
  ...
  >
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <pre className='box-border py-3 px-4 bg-gray-100 text-xs font-medium rounded-lg select-text'>
            ...
            export const API_KEY = {'\'<Web API Key From OpenBayes>\''}
          </pre>
        </div>
      </div>
    ...
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <Button
        className='w-36 mt-2'
        onClick={() => window.open(`https://docs.xiaosuan.com/apps/${locale === 'en' ? '' : `v/${locale.toLowerCase()}`}/application/developing-with-apis`, '_blank')}
      >
