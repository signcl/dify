const translation = {
  ...
  welcome: 'Welcome to OpenBayes, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting OpenBayes Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on OpenBayes',
  invalid: 'The link has expired',
  explore: 'Explore OpenBayes',
