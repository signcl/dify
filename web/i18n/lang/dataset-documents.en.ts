const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the dataset are shown here, and the entire dataset can be linked to OpenBayes citations or indexed via the Chat plugin.',
    addFile: 'add file',
    addPages: 'Add Pages',
    table: {
      header: {
    ...
    empty: {
      ...
      sync: {
        tip: 'OpenBayes will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
