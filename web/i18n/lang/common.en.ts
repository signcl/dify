const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'OpenBayes account',
    langGeniusAccountTip: 'Your OpenBayes account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to OpenBayes to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by OpenBayes allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'OpenBayes {{version}} is now available.',
    latestAvailable: 'OpenBayes {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
