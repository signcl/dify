...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for OpenBayes Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "OpenBayes Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
